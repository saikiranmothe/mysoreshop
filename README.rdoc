#testing testing
#testing with codeship_CD process2
#testing with codeship_CD process
#testing with codeship_CI
#testing heroku deployment with semaphore_CI
#testing`
*email/username: admin@admin.com
*password: password

*email/username: admin@eangadi.com
*password: password
